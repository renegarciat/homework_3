...
double left_0 = 0; // Control input to the left wheel for the rotation control in cm/s.
double right_0 = 0; // Control input to the right wheel for the rotation control in cm/s.
double left_1 = 0; // Control input to the left wheel for the pose control in cm/s.
double right_1 = 0; // Control input to the right wheel for the pose control in cm/s.